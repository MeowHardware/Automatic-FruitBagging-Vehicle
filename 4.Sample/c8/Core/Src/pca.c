...
uint8_t PCA9685_read(uint8_t startAddress) {
    ...
    HAL_I2C_Master_Transmit(hi2c2x,PCA9685_adrr, tx,1,10000);
    HAL_I2C_Master_Receive(hi2c2x,PCA9685_adrr,buffer,1,10000);
    return buffer[0];
}
...
void PCA9685_write(uint8_t startAddress, uint8_t buffer) {
    ...
    tx[0]=startAddress;
    tx[1]=buffer;
    HAL_I2C_Master_Transmit(hi2c2x,PCA9685_adrr, tx,2,10000);
